...
|---|---|---|
| `AZURE_CLIENT_ID` | Secret | New app registration `github-actions-job-scraper-function` (appId `79e3227a-5493-41c2-92ab-c98f3de09395`), OIDC federated credentials added for `ref:refs/heads/main`, `environment:dev`, `environment:production`, and `pull_request` subjects — no client secret stored, ever. |
